...
public class Attach {
	...
	public static void upload(String memId, MultipartFile f) throws AddException {
		...
		String saveFileName =memId + "_" + UUID.randomUUID() + "_" + originName; 
	...
	public static void upload(String memId, List<MultipartFile> list) throws AddException {
